...
Tags:  Accordion, accordions, accordions plugin, accordions plugin jquery, accordions plugin wordpress, accordions short-code, accordions Widget, jQuery accordions, Responsive accordions
...
* [Upgrade to Premium!&raquo;](http://themepoints.com/product/wp-accordions-pro/)
...
* Unlimited accordion anywhere in the theme.
* Work in all browsers and mobile devices.
* Self hosted auto updated enable.
* Well Documentation.
  And much more!
...
https://www.youtube.com/watch?v=sFlUNTA80N4
...
3.After activate plugin you will see "Accordion" menu at left side on WordPress dashboard and find "Accordion Option settings"
