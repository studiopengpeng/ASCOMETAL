...
//custom css generator hover option improved
//custom css generator options to implement font icons on text labels
...
require_once dirname(__FILE__) . '/modules/layers-extension.php';
