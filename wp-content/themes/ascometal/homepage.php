    ...
    <div id="page" role="main">
        ...
        <?php do_action( 'foundationpress_before_content' ); ?>
            <?php while ( have_posts() ) : the_post(); ?>
                ...
                <section  class="small-12 medium-12 large-12 columns" <?php post_class( 'main-content') ?> id="post-
                    <?php the_ID(); ?>">
                       <div id="markets">
                                ...
                                <article class="rolling small-12 medium-6 large-3 columns">
                                    ...
                                    <div class="ih-item square effect13 top_to_bottom">
                                        <a href="#">
                                            ...
                                            <div class="img">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/rolling.jpg" alt="automobile Ascometal">
                                            </div>
                                            <div class="info rol">
                                                <h3>Roulements</h3>
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/rolling.svg" alt="automobile Ascometal">
                                ...
                                <article class="mechanical small-12 medium-6 large-3 columns">
                                    ...
                                    <div class="ih-item square effect13 top_to_bottom">
                                        <a href="#">
                                            ...
                                            <div class="img">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/mechanical.jpg" alt="automobile Ascometal">
                                            </div>
                                            <div class="info mec">
                                                <h3>Mécanique</h3>
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/mechanical.svg" alt="automobile Ascometal">
                                                <p>Un partenariat durable avec les roulements mondiaux...
                                                </p>
                                               <p class="seemore">voir+</p>
                                            </div>
                                ...
                                <article class="petrol small-12 medium-6 large-3 columns">
                                    ...
                                    <div class="ih-item square effect13 top_to_bottom">
                                        <a href="#">
                                            ...
                                            <div class="img">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/petrol.jpg" alt="automobile Ascometal">
                                            </div>
                                            <div class="info pet">
                                                <h3>Pétrole</h3>
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/petrol.svg" alt="automobile Ascometal">
